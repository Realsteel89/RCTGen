...
enum : uint64_t
{
	...
	// Bremsen und Booster und Co
	
	TRACK_SPECIAL_BRAKE = 0x10000000,
	TRACK_SPECIAL_BLOCK_BRAKE_CLASSIC = 0x11000000,
	TRACK_SPECIAL_BLOCK_BRAKE_OPEN = 0x12000000,
	TRACK_SPECIAL_BLOCK_BRAKE_CLOSED = 0x13000000,
	TRACK_SPECIAL_BOOSTER = 0x14000000,
	TRACK_SPECIAL_MAGNETIC_BRAKE = 0x15000000,
	TRACK_SPECIAL_LAUNCHED_LIFT = 0x16000000,
	TRACK_SPECIAL_VERTICAL_BOOSTER = 0x17000000,
	TRACK_SPECIAL_ROTATION_CONTROL_TOGGLE = 0x1800000,
...
enum track_groups : uint64_t
{
	...
	TRACK_GROUP_BLOCK_BRAKES_CLASSIC = 0x2000000000, // Korrigiert
	TRACK_GROUP_BLOCK_BRAKES_OPEN = 0x4000000000,    // Korrigiert
	TRACK_GROUP_BLOCK_BRAKES_CLOSED = 0x8000000000,  // Korrigiert
	TRACK_GROUP_DIAGONAL_BLOCK_BRAKES_OPEN = 0x10000000000,
	TRACK_GROUP_DIAGONAL_BLOCK_BRAKES_CLOSED = 0x20000000000,

	TRACK_GROUP_VERY_SMALL_TURNS = 0x40000000000,   // Verschoben
	TRACK_GROUP_ROTATION_CONTROL_TOGGLE = 0x80000000000 // Verschoben
};
...
enum models
{
	...
	MODEL_BASE,
	MODEL_SPECIAL_BRAKE,
	MODEL_SPECIAL_BLOCK_BRAKE_CLASSIC,
	MODEL_SPECIAL_BLOCK_BRAKE_OPEN,
	MODEL_SPECIAL_BLOCK_BRAKE_CLOSED,
	MODEL_SPECIAL_BOOSTER,
	MODEL_SPECIAL_ROTATION_CONTROL_TOGGLE,
...
typedef struct
{
	...
	track_section_t rotation_control_toggle;
	}
track_list_t;
